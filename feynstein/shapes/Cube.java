  ...
  public Cube compileShape() {
    ...
    ArrayList<Triangle> triangles = new ArrayList<Triangle>(
        Arrays.asList(new Triangle[] {
          new Triangle(0,1,3), new Triangle(0,1,5), new Triangle(0,3,2),
          new Triangle(0,2,6), new Triangle(0,5,4), new Triangle(0,6,4),
          new Triangle(1,3,7), new Triangle(1,7,5), new Triangle(2,3,7),
          new Triangle(2,7,6), new Triangle(4,5,7), new Triangle(4,7,6)}));
