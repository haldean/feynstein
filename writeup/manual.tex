...
\begin{figure}
  \centering
  \includegraphics{img/Tetrahedral}
...
force ::= 'force' 'GravityForce' '(' forceParams gravityParams ')' 
  ...
  | 'force' 'TetrahedralConstraintForce' '(' forceParams tetParams ')' 
  | 'force' 'ContactForce' '(' forceParams contactParams ')' 

forceParams ::= 'actsOn' '=' '#' STRING

gravityParams ::= 'length' '=' NUMBER CENTIMETERS ',' 'strength' '=' NUMBER
...
springPenaltyParams ::= 'proximity' '=' NUMBER ',' 'detector' '=' '#' STRING | 'proximity' '=' NUMBER ',' 'detector' '=' '#' STRING ',' 'stiffness' '=' NUMBER 
