...
\code{int decimal string boolean void shape force property}
...
The possible properties are \code{ImpulseResponder, SemiImplicitEuler,
  VelocityVerlet, ContinuousTimeDetector, BoundingVolumeHierarchy,
  ProximityDetector} and \code{SpringPenaltyResponder}.
