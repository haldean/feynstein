ClothScene {
    boolean flip = false;
    shapes {
	shape FluidPlane(name="cloth", subdivisions=20, length=30);
	...
	force TriangleForce(actsOn=#cloth, youngs=100, poisson=0.1);
    }
	...
	property SpringPenaltyResponder(detector=0, stiffness=10);
	//property SemiImplicitEuler(stepSize=0.01);
   }
